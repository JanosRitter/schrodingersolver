...
# normierung der Wellenfunktionen
    ...
    wavefunc_data_slice = np.concatenate((np.expand_dims(potential_data[:,0], axis=1), wavefunc_data[:,first_ev - 1:last_ev]), axis=1)
    #wavefunc_data_slice = wavefunc_data[:,first_ev - 1:last_ev]
